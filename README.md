...
A modern SaaS web application built with Next.js 16.1.1, TypeScript, and Clerk authentication. Features dark/light mode theming, modular component architecture, and a focus on type safety and user experience.
...
- `components/`: Reusable UI components (ui/, header, providers)
...
No translation system is currently implemented. Text is hardcoded in English. For internationalization, consider adding next-intl and configuring locales.
